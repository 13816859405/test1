...
<div id="main" class="wrap">
	...
	<div class="main">
		<h2>添加分类</h2>
		<div class="manage">
			<form action="CategoryServlet?pro=addCat" method="post">
				<table class="form">
					<tr>
						...
						<td>
							<select name="parentId">
								...
								<c:forEach items="${map }" var="parentCat" varStatus="sta">
									<option value="${parentCat.key.parentId }">${parentCat.key.epcName}</option>
								</c:forEach>
								
							</select>
							自定义：<input type="text"  name="parentNew" value="" /></td>
						</td>
