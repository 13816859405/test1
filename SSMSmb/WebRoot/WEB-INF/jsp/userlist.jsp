        ...
        <div class="right">
			...
			<input type="hidden" id="totalPageCount" value="${totalPageCount}"/>
		  	<p>
		  		...
		  		<a href="${pageContext.request.contextPath }/userList.html?pageNo=1&queryname=${queryUserName}&queryUserRole=${queryUserRole}">首页</a>
		  		<c:if test="${pageBean.pageNo!=1 }">
		  		<a href="${pageContext.request.contextPath }/userList.html?pageNo=${pageBean.pageNo-1 }&queryname=${queryUserName}&queryUserRole=${queryUserRole}">上一页</a>
		  		</c:if>
		  		<c:if test="${pageBean.totalPages!=pageBean.pageNo&&pageBean.totalPages!=0 }">
		  		<a href="${pageContext.request.contextPath }/userList.html?pageNo=${pageBean.pageNo+1 }&queryname=${queryUserName}&queryUserRole=${queryUserRole}">下一页</a>
		  		</c:if>
		  		<a href="${pageContext.request.contextPath }/userList.html?pageNo=${pageBean.totalPages}&queryname=${queryUserName}&queryUserRole=${queryUserRole}">尾页</a>
		  	</p>
		  	<div class="providerAdd">
		  		...
		  		<div>
		  			<label>出生日期</label>
		  			<input type="text" id="v_birthday" class="Wdate" onclick="WdatePicker()" value="" readonly="readonly">
		  		</div>
		  		<div>
		  			<label>用户电话</label>
