...
<%@include file="./common/head.jsp"%>
  ...
  <div class="right">
      ...
      <div class="providerAdd">
          <form id="providerForm" name="providerForm" method="post" action="${pageContext.request.contextPath }/pro/updatepro.html?id=${provider.id }">
              ...
              <div>
                 ...
                 <input type="text" name="name" id="proName" value="${provider.name }"> 
			<font color="red"></font>
              </div>
			...
			<font color="red"></font>
              ...
              <div>
                  ...
                  <input type="text" name="desc" id="proDesc" value="${provider.desc }"> 
              </div>
