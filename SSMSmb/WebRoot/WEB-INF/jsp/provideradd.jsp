...
<div class="right">
        ...
        <div class="providerAdd">
           <form id="providerForm" name="providerForm" method="post" action="${pageContext.request.contextPath }/pro/addpro.html">
			<input type="hidden" name="method" value="add">
                ...
                <div>
                   ...
                   <input type="text" name="name" id="proName" value=""> 
					<font color="red"></font>
                </div>
                <div>
                ...
                <div>
                    ...
                    <input type="text" name="desc" id="proDesc" value=""> 
                </div>
